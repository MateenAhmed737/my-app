      ...
      <div className="mt-5 sm:w-8/12">
        <form onSubmit={handleSubmit} id="current-form">
          <h2 className="text-lg">
            Nennen Sie uns Ihre{" "}
            <span className="font-semibold text-blue-700">Wohnfläche ?</span>
          </h2>
          <h2 className="mt-3 text-xs font-normal">
            Die Wohnfläche bezeichnet die Summe der anrechenbaren Grundfläche
          ...
          <div className="mt-8 text-left">
            ...
            >
              Länge der wohnung in m² <sup className="text-red-600">*</sup>
            </label>
            <br />
            <br />
